    ...
    <main className="content page__content">
      <section className="auth">
        <form name={`${props.name}`} className="auth__form" onSubmit={props.onSubmit}>
          ...
          <input name="email" className="auth__input" placeholder="Email" type="email" onChange={props.onChange} required/>
          <input name="password" className="auth__input" placeholder="Пароль" type="password" onChange={props.onChange} required/>
